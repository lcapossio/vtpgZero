#!/usr/bin/env python3
"""Run the interlaced-video field ID (m_axis_fid) regression with Icarus."""
...
def main() -> int:
    ...
    if "PASS: tb_interlace" not in proc.stdout:
        print("ERROR: tb_interlace did not report PASS.", file=sys.stderr)
        return 1
    return 0
