...
module sim_top #(
    ...
    vtpgz_axilite_top #(
        ...
        .aclk          (aclk),
        .aresetn       (aresetn),
        .s_axil_awaddr (vtpgz_awaddr),
        .s_axil_awprot (3'b000),
        .s_axil_awvalid(vtpgz_awvalid),
        .s_axil_awready(vtpgz_awready),
        .s_axil_wdata  (vtpgz_wdata),
        .s_axil_wstrb  (vtpgz_wstrb),
        .s_axil_wvalid (vtpgz_wvalid),
        .s_axil_wready (vtpgz_wready),
        .s_axil_bresp  (vtpgz_bresp),
        .s_axil_bvalid (vtpgz_bvalid),
        .s_axil_bready (vtpgz_bready),
        .s_axil_araddr (vtpgz_araddr),
        .s_axil_arprot (3'b000),
        .s_axil_arvalid(vtpgz_arvalid),
        .s_axil_arready(vtpgz_arready),
        .s_axil_rdata  (vtpgz_rdata),
        .s_axil_rresp  (vtpgz_rresp),
        .s_axil_rvalid (vtpgz_rvalid),
        .s_axil_rready (vtpgz_rready),
